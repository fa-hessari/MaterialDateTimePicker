 ...
 */
public abstract class MonthViewGig extends View {
  ...
  protected DatePickerControllerGig mController;
  ...
  public MonthViewGig(Context context) {
    this(context, null, null);
  }

  public MonthViewGig(Context context, AttributeSet attr, DatePickerControllerGig controller) {
    super(context, attr);
    ...
    mDayOfWeekTypeface = res.getString(
        com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_day_of_week_label_typeface);
    mMonthTitleTypeface =
        res.getString(com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_sans_serif);

    boolean darkTheme = mController != null && mController.isThemeDark();
    if (darkTheme) {
      mDayTextColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_text_normal_dark_theme);
      mMonthDayTextColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_month_day_dark_theme);
      mDisabledDayTextColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_text_disabled_dark_theme);
      mHighlightedDayTextColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_text_highlighted_dark_theme);
    } else {
      mDayTextColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_text_normal);
      mMonthDayTextColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_month_day);
      mDisabledDayTextColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_text_disabled);
      mHighlightedDayTextColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_text_highlighted);
    }
    mSelectedDayTextColor = ContextCompat.getColor(context,
        com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_white);
    mTodayNumberColor = mController.getAccentColor();
    mMonthTitleColor = ContextCompat.getColor(context,
        com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_white);

    mStringBuilder = new StringBuilder(50);

    MINI_DAY_NUMBER_TEXT_SIZE = res.getDimensionPixelSize(
        com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_day_number_size);
    MONTH_LABEL_TEXT_SIZE = res.getDimensionPixelSize(
        com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_month_label_size);
    MONTH_DAY_LABEL_TEXT_SIZE = res.getDimensionPixelSize(
        com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_month_day_label_text_size);
    MONTH_HEADER_SIZE = res.getDimensionPixelOffset(
        com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_month_list_item_header_height);
    MONTH_HEADER_SIZE_V2 = res.getDimensionPixelOffset(
        com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_month_list_item_header_height_v2);
    DAY_SELECTED_CIRCLE_SIZE = mController.getVersion() == DatePickerDialogGig.Version.VERSION_1
        ? res.getDimensionPixelSize(
            com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_day_number_select_circle_radius)
            : res.getDimensionPixelSize(
                com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_day_number_select_circle_radius_v2);
    DAY_HIGHLIGHT_CIRCLE_SIZE = res.getDimensionPixelSize(
        com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_day_highlight_circle_radius);
    DAY_HIGHLIGHT_CIRCLE_MARGIN = res.getDimensionPixelSize(
        com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_day_highlight_circle_margin);

    if (mController.getVersion() == DatePickerDialogGig.Version.VERSION_1) {
      ...
      mRowHeight = (res.getDimensionPixelOffset(
          com.golrangsystem.materialdatetimepicker.R.dimen.fh_gig_mdtp_date_picker_view_animator_height_v2)
              - getMonthHeaderSize()
              - MONTH_DAY_LABEL_TEXT_SIZE * 2) / MAX_NUM_ROWS;
    }

    mEdgePadding = mController.getVersion() == DatePickerDialogGig.Version.VERSION_1 ? 0
  ...
  @SuppressWarnings("unused") public void setSelectedDay(int day) {
    mSelectedDay = day;
  }
  ...
  public int getMonthHeight() {
    int scaleFactor = mController.getVersion() == DatePickerDialogGig.Version.VERSION_1 ? 2 : 3;
  ...
  protected int getMonthHeaderSize() {
    return mController.getVersion() == DatePickerDialogGig.Version.VERSION_1 ? MONTH_HEADER_SIZE
        : MONTH_HEADER_SIZE_V2;
  }

  @NonNull private String getMonthAndYearString() {
    Locale locale = mController.getLocale();
    String pattern = "MMMM yyyy";

    if (Build.VERSION.SDK_INT < 18) {
      pattern = getContext().getResources()
          .getString(
              com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_date_v1_monthyear);
    } else {
  ...
  protected void drawMonthTitle(Canvas canvas) {
    int x = mWidth / 2;
    int y =
        mController.getVersion() == DatePickerDialogGig.Version.VERSION_1 ? (getMonthHeaderSize()
        - MONTH_DAY_LABEL_TEXT_SIZE) / 2 : getMonthHeaderSize() / 2 - MONTH_DAY_LABEL_TEXT_SIZE;
  ...
  private void onDayClick(int day) {
    ...
    if (mOnDayClickListener != null) {
      mOnDayClickListener.onDayClick(this,
          new MonthAdapterGig.CalendarDay(mYear, mMonth, day, mController.getTimeZone()));
    }
  ...
  private String getWeekDayLabel(Calendar day) {
    ...
    if (Build.VERSION.SDK_INT < 18) {
      ...
      if (locale.getLanguage().equals("ca")) dayLabel = dayName.toLowerCase().substring(0, 2);
   ...
   * has focus
   */
  public MonthAdapterGig.CalendarDay getAccessibilityFocus() {
    final int day = mTouchHelper.getAccessibilityFocusedVirtualViewId();
    if (day >= 0) {
      return new MonthAdapterGig.CalendarDay(mYear, mMonth, day, mController.getTimeZone());
    }
    return null;
  }
   ...
   */
  public boolean restoreAccessibilityFocus(MonthAdapterGig.CalendarDay day) {
  ...
  public interface OnDayClickListener {
    void onDayClick(MonthViewGig view, MonthAdapterGig.CalendarDay day);
  }
  ...
  protected class MonthViewTouchHelper extends ExploreByTouchHelper {
    ...
    void setFocusedVirtualView(int virtualViewId) {
      getAccessibilityNodeProvider(MonthViewGig.this).performAction(virtualViewId,
    ...
    void clearFocusedVirtualView() {
      ...
      if (focusedVirtualView != ExploreByTouchHelper.INVALID_ID) {
        getAccessibilityNodeProvider(MonthViewGig.this).performAction(focusedVirtualView,
