...
public class DatePickerDialog extends DialogFragment
  ...
  private int mOkResId = com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_ok;
  private String mOkString;
  private int mOkColor = -1;
  private int mCancelResId = com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_cancel;
  ...
  private int mChangeToShamsiResId =
      com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_change_to_shamsi;
   ...
   * @return a new DatePickerDialog instance
   */
  @SuppressWarnings("unused") public static DatePickerDialog newInstance(
   ...
   * @return a new DatePickerDialog instance
   */
  @SuppressWarnings("unused") public static DatePickerDialog newInstance(OnDateSetListener callback,
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    if (Build.VERSION.SDK_INT < 18) {
      VERSION_2_FORMAT = new SimpleDateFormat(activity.getResources()
          .getString(
              com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_date_v2_daymonthyear),
          mLocale);
    } else {
      VERSION_2_FORMAT =
  ...
  @Override public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    int viewRes = mVersion == Version.VERSION_1
        ? com.golrangsystem.materialdatetimepicker.R.layout.fh_gig_mdtp_date_picker_dialog
        : com.golrangsystem.materialdatetimepicker.R.layout.fh_gig_mdtp_date_picker_dialog_v2;
    View view = inflater.inflate(viewRes, container, false);
    // All options have been set at this point: round the initial selection if necessary
    mCalendar = mDateRangeLimiter.setToNearestDate(mCalendar);

    mDatePickerHeaderView = view.findViewById(
        com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_header);
    mMonthAndDayView = view.findViewById(
        com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_month_and_day);
    mMonthAndDayView.setOnClickListener(this);
    mSelectedMonthTextView = view.findViewById(
        com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_month);
    mSelectedDayTextView = view.findViewById(
        com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_day);
    mYearView = view.findViewById(
        com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_year);
    ...
    mDayPickerDescription = res.getString(
        com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_day_picker_description);
    mSelectDay =
        res.getString(com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_select_day);
    mYearPickerDescription = res.getString(
        com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_year_picker_description);
    mSelectYear =
        res.getString(com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_select_year);

    int bgColorResource = mThemeDark
        ? com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_view_animator_dark_theme
        : com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_view_animator;
    int bgColor = ContextCompat.getColor(activity, bgColorResource);
    view.setBackgroundColor(bgColor);

    mAnimator =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_animator);
    ...
    Button okButton =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_ok);
    okButton.setOnClickListener(v -> {
      tryVibrate();
      notifyOnDateListener();
      dismiss();
    });
    okButton.setTypeface(ResourcesCompat.getFont(activity,
    ...
    cancelButton.setTypeface(ResourcesCompat.getFont(activity,
        com.golrangsystem.materialdatetimepicker.R.font.robotomedium));
    ...
    view.findViewById(
        com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_day_picker_selected_date_layout)
    ...
    if (hasShamsiButton) {
      Button changeToShamsiBt = view.findViewById(
          com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_change_to_shamsi);
   ...
   */
  @SuppressWarnings("unused") public void setDateRangeLimiter(DateRangeLimiter dateRangeLimiter) {
   ...
   */
  @SuppressWarnings("unused") public OnDateSetListener getOnDateSetListener() {
    return mCallBack;
  }
  ...
  @Override public void onClick(View v) {
    tryVibrate();
    if (v.getId() == com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_year) {
