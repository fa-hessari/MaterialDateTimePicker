 ...
 */
@SuppressWarnings("WeakerAccess") public class UtilsGig {
  ...
  public static int getAccentColorFromThemeIfAvailable(Context context) {
    ...
    return ContextCompat.getColor(context, R.color.fh_gig_mdtp_accent_color);
  }
  ...
  public static boolean isDarkTheme(Context context, boolean current) {
    return resolveBoolean(context, R.attr.fh_gig_mdtp_theme_dark, current);
  }
