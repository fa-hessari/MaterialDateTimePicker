...
import static com.golrangsystem.materialdatetimepicker.time.TimePointGig.TYPE.HOUR;
import static com.golrangsystem.materialdatetimepicker.time.TimePointGig.TYPE.MINUTE;
 ...
 */
@SuppressWarnings("WeakerAccess") public class TimePointGig
    implements Parcelable, Comparable<TimePointGig> {
  public static final Parcelable.Creator<TimePointGig> CREATOR =
      new Parcelable.Creator<TimePointGig>() {
        public TimePointGig createFromParcel(Parcel in) {
          return new TimePointGig(in);
    }

        public TimePointGig[] newArray(int size) {
          return new TimePointGig[size];
    }
  };
  private int hour;
  private int minute;
  ...
  public TimePointGig(TimePointGig time) {
    this(time.hour, time.minute, time.second);
  }

  public TimePointGig(@IntRange(from = 0, to = 23) int hour,
  ...
  @Override public boolean equals(Object o) {
    ...
    TimePointGig timePointGig = (TimePointGig) o;

    return hashCode() == timePointGig.hashCode();
  }

  public boolean equals(@Nullable TimePointGig time, @NonNull TYPE resolution) {
  ...
  @Override public int compareTo(@NonNull TimePointGig t) {
