 ...
 */
public class RadialTextsViewGIg extends View {
  private final static String TAG = "RadialTextsViewGIg";
  ...
  public RadialTextsViewGIg(Context context) {
    super(context);
  ...
  public void initialize(Context context, String[] texts, String[] innerTexts,
    ...
    // Set up the paint.
    int textColorRes = controller.isThemeDark()
        ? com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_white
        : com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_numbers_text_color;
    mPaint.setColor(ContextCompat.getColor(context, textColorRes));
    String typefaceFamily = res.getString(
        com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_radial_numbers_typeface);
    ...
    if (mIs24HourMode || controller.getVersion() != TimePickerDialogGig.Version.VERSION_1) {
      ...
      mCircleRadiusMultiplier = Float.parseFloat(res.getString(
          com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_circle_radius_multiplier));
      mAmPmCircleRadiusMultiplier = Float.parseFloat(res.getString(
          com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_ampm_circle_radius_multiplier));
    }
    ...
    if (mHasInnerCircle) {
      mNumbersRadiusMultiplier = Float.parseFloat(res.getString(
          com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_numbers_radius_multiplier_outer));
      ...
      if (controller.getVersion() == TimePickerDialogGig.Version.VERSION_1) {
        ...
        mInnerTextSizeMultiplier = Float.parseFloat(res.getString(
            com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_text_size_multiplier_inner));
      } else {
        mTextSizeMultiplier = Float.parseFloat(res.getString(
            com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_text_size_multiplier_outer_v2));
        mInnerTextSizeMultiplier = Float.parseFloat(res.getString(
            com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_text_size_multiplier_inner_v2));
      }
      ...
      mNumbersRadiusMultiplier = Float.parseFloat(res.getString(
          com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_numbers_radius_multiplier_normal));
      mTextSizeMultiplier = Float.parseFloat(res.getString(
          com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_text_size_multiplier_normal));
    }
  ...
  private class InvalidateUpdateListener implements AnimatorUpdateListener {
    @Override public void onAnimationUpdate(ValueAnimator animation) {
      RadialTextsViewGIg.this.invalidate();
    }
  }
}
