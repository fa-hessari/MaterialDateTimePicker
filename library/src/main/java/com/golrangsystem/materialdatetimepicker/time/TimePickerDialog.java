...
import com.golrangsystem.materialdatetimepicker.HapticFeedbackController;
import com.golrangsystem.materialdatetimepicker.Utils;
...
public class TimePickerDialog extends DialogFragment
   ...
   */
  @SuppressWarnings("SameParameterValue") public static TimePickerDialog newInstance(
   ...
   * @return a new TimePickerDialog instance.
   */
  @SuppressWarnings({ "unused", "SameParameterValue" }) public static TimePickerDialog newInstance(
      OnTimeSetListener callback, boolean is24HourMode) {
    Calendar now = Calendar.getInstance();
    return TimePickerDialog.newInstance(callback, now.get(Calendar.HOUR_OF_DAY),
   ...
   */
  @SuppressWarnings("unused") public void setTimepointLimiter(TimepointLimiter limiter) {
    mLimiter = limiter;
  }
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null
      ...
      mLocale = (Locale) savedInstanceState.getSerializable(KEY_LOCALE);
             ...
             */
      mDefaultLimiter =
          mLimiter instanceof DefaultTimepointLimiter ? (DefaultTimepointLimiter) mLimiter
  ...
  @Override public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    if (mTimePicker != null) {
      mInitialTime =
          new Timepoint(mTimePicker.getHours(), mTimePicker.getMinutes(), mTimePicker.getSeconds());
    }
   ...
   */
  @Override public void onValueSelected(Timepoint newValue) {
  ...
  @Override public boolean isOutOfRange(Timepoint current, int index) {
