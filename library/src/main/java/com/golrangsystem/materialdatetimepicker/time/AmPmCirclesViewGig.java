 ...
 */
public class AmPmCirclesViewGig extends View {
  private static final String TAG = "AmPmCirclesViewGig";
  ...
  public AmPmCirclesViewGig(Context context) {
    super(context);
  ...
  public void initialize(Context context, Locale locale, TimePickerControllerGIg controller,
    ...
    if (controller.isThemeDark()) {
      mUnselectedColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_circle_background_dark_theme);
      mAmPmTextColor = ContextCompat.getColor(context,
      ...
      mUnselectedColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_white);
      mAmPmTextColor = ContextCompat.getColor(context,
          com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_ampm_text_color);
      mAmPmDisabledTextColor = ContextCompat.getColor(context,
    ...
    mTouchedColor = UtilsGig.darkenColor(mSelectedColor);
    mAmPmSelectedTextColor = ContextCompat.getColor(context,
        com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_white);
