...
import com.golrangsystem.materialdatetimepicker.HapticFeedbackControllerGig;
...
public class TimePickerDialogGIg extends DialogFragment
  ...
  private HapticFeedbackControllerGig mHapticFeedbackControllerGig;
  ...
  private RadialPickerLayoutGig mTimePicker;
  private int mSelectedColor;
  private int mUnselectedColor;
  private String mAmText;
  private String mPmText;
  private boolean mAllowAutoAdvance;
  private TimePointGig mInitialTime;
  ...
  public void initialize(OnTimeSetListener callback, int hourOfDay, int minute, int second,
    ...
    mInitialTime = new TimePointGig(hourOfDay, minute, second);
    ...
    mEnableMinutes = true;
    mOkResid = com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_ok;
    mOkColor = -1;
    mCancelResid = com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_cancel;
    mCancelColor = -1;
    mVersion =
        Build.VERSION.SDK_INT < Build.VERSION_CODES.M ? Version.VERSION_1 : Version.VERSION_2;
   ...
   */
  @SuppressWarnings("unused") public void setAccentColor(String color) {
   ...
   */
  @SuppressWarnings("unused") public void setOkColor(String color) {
   ...
   * @param color the color you want
   */
  @SuppressWarnings("unused") public void setOkColor(@ColorInt int color) {
   ...
   * @param color the color you want
   */
  @SuppressWarnings("unused") public void setCancelColor(String color) {
   ...
   * @param color the color you want
   */
  @SuppressWarnings("unused") public void setCancelColor(@ColorInt int color) {
  ...
  @Override public boolean is24HourMode() {
   ...
   */
  @SuppressWarnings("unused") public void enableMinutes(boolean enableMinutes) {
    if (!enableMinutes) mEnableSeconds = false;
    mEnableMinutes = enableMinutes;
  }

  @SuppressWarnings("unused") public void setMinTime(int hour, int minute, int second) {
    setMinTime(new TimePointGig(hour, minute, second));
  }

  public void setMinTime(TimePointGig minTime) {
    mDefaultLimiter.setMinTime(minTime);
  }

  @SuppressWarnings("unused") public void setMaxTime(int hour, int minute, int second) {
    setMaxTime(new TimePointGig(hour, minute, second));
  }

  public void setMaxTime(TimePointGig maxTime) {
   ...
   */
  public void setSelectableTimes(TimePointGig[] selectableTimes) {
   ...
   */
  public void setDisabledTimes(TimePointGig[] disabledTimes) {
  ...
  public void setTimeInterval(@IntRange(from = 1, to = 24) int hourInterval,
    ...
    List<TimePointGig> timePointGigs = new ArrayList<>();
    ...
    while (hour < 24) {
      ...
      while (minute < 60) {
        int second = 0;
        while (second < 60) {
          timePointGigs.add(new TimePointGig(hour, minute, second));
    ...
    setSelectableTimes(timePointGigs.toArray(new TimePointGig[timePointGigs.size()]));
  }
   ...
   * @param minuteInterval The interval between 2 selectable minutes ([1,60])
   */
  @SuppressWarnings("SameParameterValue") public void setTimeInterval(
      @IntRange(from = 1, to = 24) int hourInterval,
      @IntRange(from = 1, to = 60) int minuteInterval) {
   ...
   * @param hourInterval The interval between 2 selectable hours ([1,24])
   */
  @SuppressWarnings("unused") public void setTimeInterval(
      @IntRange(from = 1, to = 24) int hourInterval) {
   ...
   */
  @Deprecated public void setStartTime(int hourOfDay, int minute, int second) {
    mInitialTime = roundToNearest(new TimePointGig(hourOfDay, minute, second));
    mInKbMode = false;
  }
   ...
   */
  @SuppressWarnings({ "unused", "deprecation" }) @Deprecated public void setStartTime(int hourOfDay,
      int minute) {
  ...
  public void setInitialSelection(int hourOfDay, int minute, int second) {
    setInitialSelection(new TimePointGig(hourOfDay, minute, second));
  }
   ...
   * @param minute the minute of the hour
   */
  @SuppressWarnings("unused") public void setInitialSelection(int hourOfDay, int minute) {
   ...
   * Overrides the value given in newInstance()
   *
   * @param time the TimePointGig selected when the Dialog opens
   */
  public void setInitialSelection(TimePointGig time) {
   ...
   */
  @SuppressWarnings("unused") public void setOkText(String okString) {
    mOkString = okString;
  }
   ...
   */
  @SuppressWarnings("unused") public void setCancelText(String cancelString) {
   ...
   */
  @SuppressWarnings("unused") public void setTimepointLimiter(TimePointLimiterGig limiter) {
    mLimiter = limiter;
  }
   ...
   */
  @SuppressWarnings("unused") public OnTimeSetListener getOnTimeSetListener() {
    return mCallback;
  }
   ...
   * @param locale Locale
   */
  @SuppressWarnings("unused") public void setLocale(Locale locale) {
    mLocale = locale;
  }
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null
        && savedInstanceState.containsKey(KEY_INITIAL_TIME)
  ...
  @Override public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    int viewRes = mVersion == Version.VERSION_1
        ? com.golrangsystem.materialdatetimepicker.R.layout.fh_gig_mdtp_time_picker_dialog
        : com.golrangsystem.materialdatetimepicker.R.layout.fh_gig_mdtp_time_picker_dialog_v2;
    View view = inflater.inflate(viewRes, container, false);
    KeyboardListener keyboardListener = new KeyboardListener();
    view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_time_picker_dialog)
        .setOnKeyListener(keyboardListener);

    // If an accent color has not been set manually, get it from the context
    if (mAccentColor == -1) {
      mAccentColor = UtilsGig.getAccentColorFromThemeIfAvailable(getActivity());
    }

    // if theme mode has not been set by java code, check if it is specified in Style.xml
    if (!mThemeDarkChanged) {
      mThemeDark = UtilsGig.isDarkTheme(getActivity(), mThemeDark);
    }

    Resources res = getResources();
    Context context = requireActivity();
    mHourPickerDescription = res.getString(
        com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_hour_picker_description);
    mSelectHours =
        res.getString(com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_select_hours);
    mMinutePickerDescription = res.getString(
        com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_minute_picker_description);
    mSelectMinutes =
        res.getString(com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_select_minutes);
    mSecondPickerDescription = res.getString(
        com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_second_picker_description);
    mSelectSeconds =
        res.getString(com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_select_seconds);
    mSelectedColor = ContextCompat.getColor(context,
        com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_white);
    mUnselectedColor = ContextCompat.getColor(context,
        com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_accent_color_focused);

    mHourView = view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_hours);
    mHourView.setOnKeyListener(keyboardListener);
    mHourSpaceView =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_hour_space);
    mMinuteSpaceView =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_minutes_space);
    mMinuteView =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_minutes);
    mMinuteView.setOnKeyListener(keyboardListener);
    mSecondSpaceView =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_seconds_space);
    mSecondView =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_seconds);
    mSecondView.setOnKeyListener(keyboardListener);
    mAmTextView =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_am_label);
    mAmTextView.setOnKeyListener(keyboardListener);
    mPmTextView =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_pm_label);
    mPmTextView.setOnKeyListener(keyboardListener);
    mAmPmLayout =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_ampm_layout);
    String[] amPmTexts = new DateFormatSymbols(mLocale).getAmPmStrings();
    mAmText = amPmTexts[0];
    mPmText = amPmTexts[1];

    mHapticFeedbackControllerGig = new HapticFeedbackControllerGig(getActivity());

    if (mTimePicker != null) {
      mInitialTime = new TimePointGig(mTimePicker.getHours(), mTimePicker.getMinutes(),
    ...
    mTimePicker =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_time_picker);
    ...
    mOkButton = view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_ok);
    ...
    mOkButton.setTypeface(ResourcesCompat.getFont(context,
        com.golrangsystem.materialdatetimepicker.R.font.robotomedium));
    if (mOkString != null) {
    ...
    mCancelButton =
        view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_cancel);
    mCancelButton.setOnClickListener(v -> {
      tryVibrate();
      if (getDialog() != null) getDialog().cancel();
    });
    mCancelButton.setTypeface(ResourcesCompat.getFont(context,
        com.golrangsystem.materialdatetimepicker.R.font.robotomedium));
    ...
    if (!mEnableSeconds) {
      ...
      view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_separator_seconds)
    ...
    if (!mEnableMinutes) {
      ...
      view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_separator)
          .setVisibility(View.GONE);
    }
    ...
    if (isLandscape) {
      if (!mEnableMinutes && !mEnableSeconds) {
        ...
        RelativeLayout.LayoutParams paramsHour =
            new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        paramsHour.addRule(RelativeLayout.ABOVE,
            com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_center_view);
        ...
        if (mIs24HourMode) {
          ...
          RelativeLayout.LayoutParams paramsAmPm =
              new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                  ViewGroup.LayoutParams.WRAP_CONTENT);
          paramsAmPm.addRule(RelativeLayout.RIGHT_OF,
              com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_hour_space);
        ...
        paramsSeparator.addRule(RelativeLayout.ABOVE,
            com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_center_view);
        ...
        paramsAmPm.addRule(RelativeLayout.BELOW,
            com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_center_view);
        mAmPmLayout.setLayoutParams(paramsAmPm);
        ...
        paramsSeparator.addRule(RelativeLayout.CENTER_HORIZONTAL);
        paramsSeparator.addRule(RelativeLayout.ABOVE,
            com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_seconds_space);
        TextView separatorView =
            view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_separator);
        separatorView.setLayoutParams(paramsSeparator);
        // Center the seconds
        RelativeLayout.LayoutParams paramsSeconds =
            new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
      ...
      if (!mIs24HourMode) {
        ...
        paramsAmPm.addRule(RelativeLayout.RIGHT_OF,
            com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_hour_space);
        paramsAmPm.addRule(RelativeLayout.ALIGN_BASELINE,
            com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_hour_space);
        mAmPmLayout.setLayoutParams(paramsAmPm);
      }
    } else if (mEnableSeconds) {
      ...
      RelativeLayout.LayoutParams paramsSeparator =
          new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
      paramsSeparator.addRule(RelativeLayout.LEFT_OF,
          com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_minutes_space);
      ...
      if (!mIs24HourMode) {
        ...
        RelativeLayout.LayoutParams paramsMinutes =
            new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        paramsMinutes.addRule(RelativeLayout.RIGHT_OF,
            com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_center_view);
        mMinuteSpaceView.setLayoutParams(paramsMinutes);
      }
    }
    ...
    mDoublePlaceholderText = res.getString(
        com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_time_placeholder);
    mDeletedKeyFormat =
        res.getString(com.golrangsystem.materialdatetimepicker.R.string.fh_gig_mdtp_deleted_key);
    ...
    TextView timePickerHeader = view.findViewById(
        com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_time_picker_header);
    if (!mTitle.isEmpty()) {
    ...
    timePickerHeader.setBackgroundColor(UtilsGig.darkenColor(mAccentColor));
    view.findViewById(
        com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_time_display_background)
        .setBackgroundColor(mAccentColor);
    view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_time_display)
        .setBackgroundColor(mAccentColor);
    ...
    if (getDialog() == null) {
      view.findViewById(com.golrangsystem.materialdatetimepicker.R.id.fh_gig_mdtp_done_background)
          .setVisibility(View.GONE);
    }

    int circleBackground = ContextCompat.getColor(context,
        com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_circle_background);
    int backgroundColor = ContextCompat.getColor(context,
        com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_background_color);
    int darkBackgroundColor = ContextCompat.getColor(context,
        com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_light_gray);
    int lightGray = ContextCompat.getColor(context,
        com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_light_gray);
  ...
  @Override public void onResume() {
    super.onResume();
    mHapticFeedbackControllerGig.start();
  }

  @Override public void onPause() {
    super.onPause();
    mHapticFeedbackControllerGig.stop();
  ...
  @Override public void tryVibrate() {
    if (mVibrate) mHapticFeedbackControllerGig.tryVibrate();
  }
  ...
  private void updateAmPmDisplay(int amOrPm) {
    if (mVersion == Version.VERSION_2) {
      if (amOrPm == AM) {
        ...
        UtilsGig.tryAccessibilityAnnounce(mTimePicker, mAmText);
      } else {
        mAmTextView.setTextColor(mUnselectedColor);
        mPmTextView.setTextColor(mSelectedColor);
        UtilsGig.tryAccessibilityAnnounce(mTimePicker, mPmText);
      }
    } else {
      if (amOrPm == AM) {
   ...
   */
  @Override public void onValueSelected(TimePointGig newValue) {
  ...
  @Override public void advancePicker(int index) {
    ...
    if (index == HOUR_INDEX && mEnableMinutes) {
      ...
      UtilsGig.tryAccessibilityAnnounce(mTimePicker, announcement);
  ...
  @Override public void enablePicker() {
    if (!isTypedTimeFullyLegal()) mTypedTimes.clear();
    finishKbMode(true);
  }

  public boolean isOutOfRange(TimePointGig current) {
    return isOutOfRange(current, SECOND_INDEX);
  }

  @Override public boolean isOutOfRange(TimePointGig current, int index) {
    return mLimiter.isOutOfRange(current, index, getPickerResolution());
  }

  @Override public boolean isAmDisabled() {
    return mLimiter.isAmDisabled();
  }

  @Override public boolean isPmDisabled() {
    return mLimiter.isPmDisabled();
  }

  /**
   * Round a given TimePointGig to the nearest valid TimePointGig
   *
   * @param time TimePointGig - The timepoint to round
   * @return TimePointGig - The nearest valid TimePointGig
   */
  private TimePointGig roundToNearest(@NonNull TimePointGig time) {
    return roundToNearest(time, null);
  }

  @Override
  public TimePointGig roundToNearest(@NonNull TimePointGig time, @Nullable TimePointGig.TYPE type) {
    return mLimiter.roundToNearest(time, type, getPickerResolution());
  }

  /**
   * Get the configured resolution of the current picker in terms of TimePointGig components
   *
   * @return TimePointGig.TYPE (hour, minute or second)
   */
  @NonNull TimePointGig.TYPE getPickerResolution() {
    if (mEnableSeconds) return TimePointGig.TYPE.SECOND;
    if (mEnableMinutes) return TimePointGig.TYPE.MINUTE;
    return TimePointGig.TYPE.HOUR;
  }
  ...
  private void setHour(int value, boolean announce) {
    ...
    if (announce) {
      UtilsGig.tryAccessibilityAnnounce(mTimePicker, text);
    }
  }
  ...
  private void setCurrentItemShowing(int index, boolean animateCircle, boolean delayLabelAnimate,
    ...
    switch (index) {
      case HOUR_INDEX:
        ...
        if (announce) {
          UtilsGig.tryAccessibilityAnnounce(mTimePicker, mSelectHours);
        }
      ...
      case MINUTE_INDEX:
        ...
        if (announce) {
          UtilsGig.tryAccessibilityAnnounce(mTimePicker, mSelectMinutes);
        }
      ...
      default:
        ...
        if (announce) {
          UtilsGig.tryAccessibilityAnnounce(mTimePicker, mSelectSeconds);
        }
    ...
    ObjectAnimator pulseAnimator = UtilsGig.getPulseAnimator(labelToAnimate, 0.85f, 1.1f);
    ...
    if (keyCode == KeyEvent.KEYCODE_TAB) {
      ...
      if (mInKbMode) {
        if (!mTypedTimes.isEmpty()) {
          ...
          UtilsGig.tryAccessibilityAnnounce(mTimePicker,
  ...
  private boolean addKeyIfLegal(int keyCode) {
    ...
    if ((mIs24HourMode && mTypedTimes.size() == textSize) || (!mIs24HourMode
    ...
    UtilsGig.tryAccessibilityAnnounce(mTimePicker, String.format(mLocale, "%d", val));
  ...
  private void finishKbMode(boolean updateDisplays) {
    ...
    if (!mTypedTimes.isEmpty()) {
      Boolean[] enteredZeros = { false, false, false };
      int values[] = getEnteredTime(enteredZeros);
      mTimePicker.setTime(new TimePointGig(values[0], values[1], values[2]));
      if (!mIs24HourMode) {
  ...
  public TimePointGig getSelectedTime() {
