 ...
 */
public class CircleViewGig extends View {
  private static final String TAG = "CircleViewGig";
  ...
  public CircleViewGig(Context context) {
    super(context);
  ...
  public void initialize(Context context, TimePickerControllerGig controller) {
    ...
    int colorRes = controller.isThemeDark()
        ? com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_circle_background_dark_theme
        : com.golrangsystem.materialdatetimepicker.R.color.fh_gig_mdtp_circle_color;
