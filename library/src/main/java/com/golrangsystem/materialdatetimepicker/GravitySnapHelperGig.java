 ...
 */
package com.golrangsystem.materialdatetimepicker;
 ...
 */
public class GravitySnapHelperGig extends LinearSnapHelper {
  private OrientationHelper verticalHelper;
  private OrientationHelper horizontalHelper;
  private int gravity;
  private boolean isRtlHorizontal;
  private GravitySnapHelperGig.SnapListener listener;
  ...
  @SuppressWarnings("unused") public GravitySnapHelperGig(int gravity) {
    this(gravity, null);
  }

  public GravitySnapHelperGig(int gravity, SnapListener snapListener) {
  ...
  @Override public void attachToRecyclerView(@Nullable RecyclerView recyclerView)
    ...
    if (recyclerView != null) {
      if ((gravity == Gravity.START || gravity == Gravity.END)
        ...
        isRtlHorizontal =
            recyclerView.getContext().getResources().getConfiguration().getLayoutDirection()
