...
public class TextViewWithCircularIndicator extends androidx.appcompat.widget.AppCompatTextView {
  ...
  public TextViewWithCircularIndicator(Context context, AttributeSet attrs) {
    super(context, attrs);
    mCircleColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_accent_color);
    mItemIsSelectedText = context.getResources().getString(R.string.fh_gig_mdtp_item_is_selected);
