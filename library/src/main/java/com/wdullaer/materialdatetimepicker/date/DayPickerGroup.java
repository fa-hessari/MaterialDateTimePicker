...
public class DayPickerGroup extends ViewGroup
  ...
  private void init() {
    ...
    final ViewGroup content =
        (ViewGroup) inflater.inflate(R.layout.fh_gig_mdtp_daypicker_group, this, false);
    ...
    prevButton = findViewById(R.id.fh_gig_mdtp_previous_month_arrow);
    nextButton = findViewById(R.id.fh_gig_mdtp_next_month_arrow);
    ...
    if (controller.isThemeDark()) {
      int color = ContextCompat.getColor(getContext(),
          R.color.fh_gig_mdtp_date_picker_text_normal_dark_theme);
