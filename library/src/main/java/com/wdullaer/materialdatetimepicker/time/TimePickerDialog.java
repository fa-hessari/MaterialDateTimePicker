...
public class TimePickerDialog extends DialogFragment
  ...
  public void initialize(OnTimeSetListener callback, int hourOfDay, int minute, int second,
    ...
    mEnableMinutes = true;
    mOkResid = R.string.fh_gig_mdtp_ok;
    mOkColor = -1;
    mCancelResid = R.string.fh_gig_mdtp_cancel;
    mCancelColor = -1;
    mVersion =
  ...
  @Override public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    int viewRes = mVersion == Version.VERSION_1 ? R.layout.fh_gig_mdtp_time_picker_dialog
        : R.layout.fh_gig_mdtp_time_picker_dialog_v2;
    View view = inflater.inflate(viewRes, container, false);
    KeyboardListener keyboardListener = new KeyboardListener();
    view.findViewById(R.id.fh_gig_mdtp_time_picker_dialog).setOnKeyListener(keyboardListener);
    ...
    mHourPickerDescription = res.getString(R.string.fh_gig_mdtp_hour_picker_description);
    mSelectHours = res.getString(R.string.fh_gig_mdtp_select_hours);
    mMinutePickerDescription = res.getString(R.string.fh_gig_mdtp_minute_picker_description);
    mSelectMinutes = res.getString(R.string.fh_gig_mdtp_select_minutes);
    mSecondPickerDescription = res.getString(R.string.fh_gig_mdtp_second_picker_description);
    mSelectSeconds = res.getString(R.string.fh_gig_mdtp_select_seconds);
    mSelectedColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_white);
    mUnselectedColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_accent_color_focused);

    mHourView = view.findViewById(R.id.fh_gig_mdtp_hours);
    mHourView.setOnKeyListener(keyboardListener);
    mHourSpaceView = view.findViewById(R.id.fh_gig_mdtp_hour_space);
    mMinuteSpaceView = view.findViewById(R.id.fh_gig_mdtp_minutes_space);
    mMinuteView = view.findViewById(R.id.fh_gig_mdtp_minutes);
    mMinuteView.setOnKeyListener(keyboardListener);
    mSecondSpaceView = view.findViewById(R.id.fh_gig_mdtp_seconds_space);
    mSecondView = view.findViewById(R.id.fh_gig_mdtp_seconds);
    mSecondView.setOnKeyListener(keyboardListener);
    mAmTextView = view.findViewById(R.id.fh_gig_mdtp_am_label);
    mAmTextView.setOnKeyListener(keyboardListener);
    mPmTextView = view.findViewById(R.id.fh_gig_mdtp_pm_label);
    mPmTextView.setOnKeyListener(keyboardListener);
    mAmPmLayout = view.findViewById(R.id.fh_gig_mdtp_ampm_layout);
    ...
    mTimePicker = view.findViewById(R.id.fh_gig_mdtp_time_picker);
    ...
    mOkButton = view.findViewById(R.id.fh_gig_mdtp_ok);
    ...
    mCancelButton = view.findViewById(R.id.fh_gig_mdtp_cancel);
    ...
    if (!mEnableSeconds) {
      ...
      view.findViewById(R.id.fh_gig_mdtp_separator_seconds).setVisibility(View.GONE);
    }

    // Disable minutes picker
    if (!mEnableMinutes) {
      mMinuteSpaceView.setVisibility(View.GONE);
      view.findViewById(R.id.fh_gig_mdtp_separator).setVisibility(View.GONE);
    }
    ...
    if (isLandscape) {
      if (!mEnableMinutes && !mEnableSeconds) {
        ...
        paramsHour.addRule(RelativeLayout.ABOVE, R.id.fh_gig_mdtp_center_view);
        ...
        if (mIs24HourMode) {
          ...
          RelativeLayout.LayoutParams paramsAmPm =
              new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                  ViewGroup.LayoutParams.WRAP_CONTENT);
          paramsAmPm.addRule(RelativeLayout.RIGHT_OF, R.id.fh_gig_mdtp_hour_space);
        ...
        paramsSeparator.addRule(RelativeLayout.ABOVE, R.id.fh_gig_mdtp_center_view);
        TextView separatorView = view.findViewById(R.id.fh_gig_mdtp_separator);
        ...
        paramsAmPm.addRule(RelativeLayout.BELOW, R.id.fh_gig_mdtp_center_view);
        mAmPmLayout.setLayoutParams(paramsAmPm);
        ...
        RelativeLayout.LayoutParams paramsSeparator =
            new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        paramsSeparator.addRule(RelativeLayout.CENTER_HORIZONTAL);
        paramsSeparator.addRule(RelativeLayout.ABOVE, R.id.fh_gig_mdtp_seconds_space);
        TextView separatorView = view.findViewById(R.id.fh_gig_mdtp_separator);
        separatorView.setLayoutParams(paramsSeparator);
        // Center the seconds
        ...
        paramsAmPm.addRule(RelativeLayout.BELOW, R.id.fh_gig_mdtp_seconds_space);
        mAmPmLayout.setLayoutParams(paramsAmPm);
      }
      ...
      if (!mIs24HourMode) {
        RelativeLayout.LayoutParams paramsAmPm =
            new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        paramsAmPm.addRule(RelativeLayout.RIGHT_OF, R.id.fh_gig_mdtp_hour_space);
        paramsAmPm.addRule(RelativeLayout.ALIGN_BASELINE, R.id.fh_gig_mdtp_hour_space);
        mAmPmLayout.setLayoutParams(paramsAmPm);
      }
    } else if (mEnableSeconds) {
      // link separator to minutes
      final View separator = view.findViewById(R.id.fh_gig_mdtp_separator);
      RelativeLayout.LayoutParams paramsSeparator =
          new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
      paramsSeparator.addRule(RelativeLayout.LEFT_OF, R.id.fh_gig_mdtp_minutes_space);
      ...
      if (!mIs24HourMode) {
        ...
        RelativeLayout.LayoutParams paramsMinutes =
            new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        paramsMinutes.addRule(RelativeLayout.RIGHT_OF, R.id.fh_gig_mdtp_center_view);
        mMinuteSpaceView.setLayoutParams(paramsMinutes);
      }
    }
    ...
    mDoublePlaceholderText = res.getString(R.string.fh_gig_mdtp_time_placeholder);
    mDeletedKeyFormat = res.getString(R.string.fh_gig_mdtp_deleted_key);
    ...
    TextView timePickerHeader = view.findViewById(R.id.fh_gig_mdtp_time_picker_header);
    if (!mTitle.isEmpty()) {
    ...
    view.findViewById(R.id.fh_gig_mdtp_time_display_background).setBackgroundColor(mAccentColor);
    view.findViewById(R.id.fh_gig_mdtp_time_display).setBackgroundColor(mAccentColor);
    ...
    if (getDialog() == null) {
      view.findViewById(R.id.fh_gig_mdtp_done_background).setVisibility(View.GONE);
    }

    int circleBackground = ContextCompat.getColor(context, R.color.fh_gig_mdtp_circle_background);
    int backgroundColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_background_color);
    int darkBackgroundColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_light_gray);
    int lightGray = ContextCompat.getColor(context, R.color.fh_gig_mdtp_light_gray);

    mTimePicker.setBackgroundColor(mThemeDark ? lightGray : circleBackground);
    view.findViewById(R.id.fh_gig_mdtp_time_picker_dialog)
