...
public class RadialTextsView extends View {
  ...
  public void initialize(Context context, String[] texts, String[] innerTexts,
    ...
    // Set up the paint.
    int textColorRes = controller.isThemeDark() ? R.color.fh_gig_mdtp_white
        : R.color.fh_gig_mdtp_numbers_text_color;
    mPaint.setColor(ContextCompat.getColor(context, textColorRes));
    String typefaceFamily = res.getString(R.string.fh_gig_mdtp_radial_numbers_typeface);
    mTypefaceLight = Typeface.create(typefaceFamily, Typeface.NORMAL);
    String typefaceFamilyRegular = res.getString(R.string.fh_gig_mdtp_sans_serif);
    mTypefaceRegular = Typeface.create(typefaceFamilyRegular, Typeface.NORMAL);
    mPaint.setAntiAlias(true);
    mPaint.setTextAlign(Align.CENTER);

    // Set up the selected paint
    int selectedTextColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_white);
    ...
    int inactiveColorRes =
        controller.isThemeDark() ? R.color.fh_gig_mdtp_date_picker_text_disabled_dark_theme
            : R.color.fh_gig_mdtp_date_picker_text_disabled;
    ...
    if (mIs24HourMode || controller.getVersion() != TimePickerDialog.Version.VERSION_1) {
      mCircleRadiusMultiplier =
          Float.parseFloat(res.getString(R.string.fh_gig_mdtp_circle_radius_multiplier_24HourMode));
    } else {
      mCircleRadiusMultiplier =
          Float.parseFloat(res.getString(R.string.fh_gig_mdtp_circle_radius_multiplier));
      mAmPmCircleRadiusMultiplier =
          Float.parseFloat(res.getString(R.string.fh_gig_mdtp_ampm_circle_radius_multiplier));
    }
    ...
    if (mHasInnerCircle) {
      mNumbersRadiusMultiplier =
          Float.parseFloat(res.getString(R.string.fh_gig_mdtp_numbers_radius_multiplier_outer));
      mInnerNumbersRadiusMultiplier =
          Float.parseFloat(res.getString(R.string.fh_gig_mdtp_numbers_radius_multiplier_inner));

      // Version 2 layout draws outer circle bigger than inner
      if (controller.getVersion() == TimePickerDialog.Version.VERSION_1) {
        mTextSizeMultiplier =
            Float.parseFloat(res.getString(R.string.fh_gig_mdtp_text_size_multiplier_outer));
        mInnerTextSizeMultiplier =
            Float.parseFloat(res.getString(R.string.fh_gig_mdtp_text_size_multiplier_inner));
      } else {
        mTextSizeMultiplier =
            Float.parseFloat(res.getString(R.string.fh_gig_mdtp_text_size_multiplier_outer_v2));
        mInnerTextSizeMultiplier =
            Float.parseFloat(res.getString(R.string.fh_gig_mdtp_text_size_multiplier_inner_v2));
      }
      ...
      mNumbersRadiusMultiplier =
          Float.parseFloat(res.getString(R.string.fh_gig_mdtp_numbers_radius_multiplier_normal));
      mTextSizeMultiplier =
          Float.parseFloat(res.getString(R.string.fh_gig_mdtp_text_size_multiplier_normal));
    }
