...
public class AmPmCirclesView extends View {
  ...
  public void initialize(Context context, Locale locale, TimePickerController controller,
    ...
    if (controller.isThemeDark()) {
      mUnselectedColor =
          ContextCompat.getColor(context, R.color.fh_gig_mdtp_circle_background_dark_theme);
      mAmPmTextColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_white);
      mAmPmDisabledTextColor =
          ContextCompat.getColor(context, R.color.fh_gig_mdtp_date_picker_text_disabled_dark_theme);
      mSelectedAlpha = SELECTED_ALPHA_THEME_DARK;
    } else {
      mUnselectedColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_white);
      mAmPmTextColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_ampm_text_color);
      mAmPmDisabledTextColor =
    ...
    mAmPmSelectedTextColor = ContextCompat.getColor(context, R.color.fh_gig_mdtp_white);

    String typefaceFamily = res.getString(R.string.fh_gig_mdtp_sans_serif);
