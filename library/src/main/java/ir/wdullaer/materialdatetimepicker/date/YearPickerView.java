...
import com.farhadhessari.materialdatetimepicker.date.DatePickerDialog.OnDateChangedListener;
...
public class YearPickerView extends ListView implements OnItemClickListener, OnDateChangedListener {
  ...
  public YearPickerView(Context context, DatePickerController controller) {
    ...
    mChildSize = res.getDimensionPixelOffset(
        ir.wdullaer.materialdatetimepicker.R.dimen.fh_gig_mdtp_year_label_height);
    ...
    @Override public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (convertView != null) {
        ...
        v = (TextViewWithCircularIndicator) LayoutInflater.from(parent.getContext())
            .inflate(ir.wdullaer.materialdatetimepicker.R.layout.fh_gig_mdtp_year_label_text_view,
                parent, false);
