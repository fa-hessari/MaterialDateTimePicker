 ...
 */
package ir.wdullaer.materialdatetimepicker.date;
...
import ir.wdullaer.materialdatetimepicker.HapticFeedbackController;
import ir.wdullaer.materialdatetimepicker.Utils;
...
public class DatePickerDialog extends DialogFragment
  ...
  private int mOkResId = ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_ok;
  private String mOkString;
  private int mOkColor = -1;
  private int mCancelResId = ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_cancel;
  ...
  private int mChangeToShamsiResId =
      ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_change_to_shamsi;
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    if (Build.VERSION.SDK_INT < 18) {
      VERSION_2_FORMAT = new SimpleDateFormat(activity.getResources()
          .getString(ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_date_v2_daymonthyear),
          mLocale);
    } else {
      VERSION_2_FORMAT =
  ...
  @Override public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    int viewRes = mVersion == Version.VERSION_1
        ? ir.wdullaer.materialdatetimepicker.R.layout.fh_gig_mdtp_date_picker_dialog
        : ir.wdullaer.materialdatetimepicker.R.layout.fh_gig_mdtp_date_picker_dialog_v2;
    View view = inflater.inflate(viewRes, container, false);
    // All options have been set at this point: round the initial selection if necessary
    mCalendar = mDateRangeLimiter.setToNearestDate(mCalendar);

    mDatePickerHeaderView =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_header);
    mMonthAndDayView = view.findViewById(
        ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_month_and_day);
    mMonthAndDayView.setOnClickListener(this);
    mSelectedMonthTextView =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_month);
    mSelectedDayTextView =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_day);
    mYearView =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_year);
    ...
    mDayPickerDescription = res.getString(
        ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_day_picker_description);
    mSelectDay = res.getString(ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_select_day);
    mYearPickerDescription = res.getString(
        ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_year_picker_description);
    mSelectYear =
        res.getString(ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_select_year);

    int bgColorResource = mThemeDark
        ? ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_view_animator_dark_theme
        : ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_date_picker_view_animator;
    int bgColor = ContextCompat.getColor(activity, bgColorResource);
    view.setBackgroundColor(bgColor);

    mAnimator = view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_animator);
    ...
    Button okButton = view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_ok);
    ...
    okButton.setTypeface(
        ResourcesCompat.getFont(activity, ir.wdullaer.materialdatetimepicker.R.font.robotomedium));
    if (mOkString != null) {
    ...
    Button cancelButton =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_cancel);
    ...
    view.findViewById(
        ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_day_picker_selected_date_layout)
    ...
    if (hasShamsiButton) {
      Button changeToShamsiBt =
          view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_change_to_shamsi);
  ...
  @Override public void onClick(View v) {
    tryVibrate();
    if (v.getId() == ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_date_picker_year) {
