...
public class DayPickerGroup extends ViewGroup
  ...
  private void init() {
    ...
    final ViewGroup content = (ViewGroup) inflater.inflate(
        ir.wdullaer.materialdatetimepicker.R.layout.fh_gig_mdtp_daypicker_group, this, false);
    ...
    prevButton =
        findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_previous_month_arrow);
    nextButton = findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_next_month_arrow);
  ...
  private void updateButtonVisibility(int position) {
    final boolean isHorizontal =
        controller.getScrollOrientation() == DatePickerDialog.ScrollOrientation.HORIZONTAL;
  ...
  @Override protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    final int topMargin = controller.getVersion() == DatePickerDialog.Version.VERSION_1 ? 0
