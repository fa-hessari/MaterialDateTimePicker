...
import com.farhadhessari.materialdatetimepicker.date.MonthAdapter.MonthViewHolder;
import com.farhadhessari.materialdatetimepicker.date.MonthView.OnDayClickListener;
 ...
 */
@SuppressWarnings("WeakerAccess") public abstract class MonthAdapter
  ...
  static class MonthViewHolder extends RecyclerView.ViewHolder {
    ...
    void bind(int position, DatePickerController mController, CalendarDay selectedCalendarDay) {
      ...
      ((MonthView) itemView).setMonthParams(selectedDay, year, month,
