...
import com.farhadhessari.materialdatetimepicker.GravitySnapHelper;
...
public abstract class DayPickerView extends RecyclerView
  ...
  public DayPickerView(Context context, AttributeSet attrs) {
    ...
    DatePickerDialog.ScrollOrientation scrollOrientation =
        Build.VERSION.SDK_INT < Build.VERSION_CODES.M ? DatePickerDialog.ScrollOrientation.VERTICAL
  ...
  public void init(Context context, DatePickerDialog.ScrollOrientation scrollOrientation) {
    @RecyclerView.Orientation int layoutOrientation =
        scrollOrientation == DatePickerDialog.ScrollOrientation.VERTICAL ? RecyclerView.VERTICAL
  ...
  protected void setUpRecyclerView(DatePickerDialog.ScrollOrientation scrollOrientation) {
    ...
    int gravity = scrollOrientation == DatePickerDialog.ScrollOrientation.VERTICAL ? Gravity.TOP
        : Gravity.START;
  ...
  public boolean goTo(MonthAdapter.CalendarDay day, boolean animate, boolean setSelected,
    ...
    final int position =
        (day.year - mController.getMinYear()) * MonthAdapter.MONTHS_IN_YEAR + day.month - minMonth;
