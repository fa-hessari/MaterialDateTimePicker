...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
  ...
  public RadialPickerLayout(Context context, AttributeSet attrs) {
    ...
    mGrayBox.setBackgroundColor(ContextCompat.getColor(context,
        ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_transparent_black));
  ...
  public void initialize(Context context, Locale locale, TimePickerController timePickerController,
    ...
    mHourRadialTextsView.initialize(context, hoursTexts, (is24HourMode ? innerHoursTexts : null),
    ...
    mMinuteRadialTextsView.initialize(context, minutesTexts, null, mController, minuteValidator,
        false);
    mMinuteRadialTextsView.setSelection(initialTime.getMinute());
    mMinuteRadialTextsView.invalidate();
    mSecondRadialTextsView.initialize(context, secondsTexts, null, mController, secondValidator,
        false);
  ...
  private Timepoint getTimeFromDegrees(int degrees, boolean isInnerCircle,
  ...
  private int getDegreesFromCoords(float pointX, float pointY, boolean forceLegal,
    ...
    switch (getCurrentItemShowing()) {
      case HOUR_INDEX:
        return mHourRadialSelectorView.getDegreesFromCoords(pointX, pointY, forceLegal,
            isInnerCircle);
      case MINUTE_INDEX:
        return mMinuteRadialSelectorView.getDegreesFromCoords(pointX, pointY, forceLegal,
            isInnerCircle);
      case SECOND_INDEX:
        return mSecondRadialSelectorView.getDegreesFromCoords(pointX, pointY, forceLegal,
            isInnerCircle);
      default:
        return -1;
    }
