 ...
 */
package ir.wdullaer.materialdatetimepicker.time;
...
import com.farhadhessari.materialdatetimepicker.HapticFeedbackController;
import com.farhadhessari.materialdatetimepicker.Utils;
...
public class TimePickerDialog extends DialogFragment
  ...
  public void initialize(OnTimeSetListener callback, int hourOfDay, int minute, int second,
    ...
    mEnableMinutes = true;
    mOkResid = ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_ok;
    mOkColor = -1;
    mCancelResid = ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_cancel;
    mCancelColor = -1;
    mVersion =
  ...
  @Override public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    int viewRes = mVersion == Version.VERSION_1
        ? ir.wdullaer.materialdatetimepicker.R.layout.fh_gig_mdtp_time_picker_dialog
        : ir.wdullaer.materialdatetimepicker.R.layout.fh_gig_mdtp_time_picker_dialog_v2;
    View view = inflater.inflate(viewRes, container, false);
    KeyboardListener keyboardListener = new KeyboardListener();
    view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_time_picker_dialog)
    ...
    mHourPickerDescription = res.getString(
        ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_hour_picker_description);
    mSelectHours =
        res.getString(ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_select_hours);
    mMinutePickerDescription = res.getString(
        ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_minute_picker_description);
    mSelectMinutes =
        res.getString(ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_select_minutes);
    mSecondPickerDescription = res.getString(
        ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_second_picker_description);
    mSelectSeconds =
        res.getString(ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_select_seconds);
    mSelectedColor = ContextCompat.getColor(context,
        ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_white);
    mUnselectedColor = ContextCompat.getColor(context,
        ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_accent_color_focused);

    mHourView = view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_hours);
    mHourView.setOnKeyListener(keyboardListener);
    mHourSpaceView =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_hour_space);
    mMinuteSpaceView =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_minutes_space);
    mMinuteView = view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_minutes);
    mMinuteView.setOnKeyListener(keyboardListener);
    mSecondSpaceView =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_seconds_space);
    mSecondView = view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_seconds);
    mSecondView.setOnKeyListener(keyboardListener);
    mAmTextView = view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_am_label);
    mAmTextView.setOnKeyListener(keyboardListener);
    mPmTextView = view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_pm_label);
    mPmTextView.setOnKeyListener(keyboardListener);
    mAmPmLayout =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_ampm_layout);
    ...
    mTimePicker =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_time_picker);
    ...
    mOkButton = view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_ok);
    ...
    mOkButton.setTypeface(
        ResourcesCompat.getFont(context, ir.wdullaer.materialdatetimepicker.R.font.robotomedium));
    if (mOkString != null) {
    ...
    mCancelButton = view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_cancel);
    mCancelButton.setOnClickListener(v -> {
      tryVibrate();
      if (getDialog() != null) getDialog().cancel();
    });
    mCancelButton.setTypeface(
        ResourcesCompat.getFont(context, ir.wdullaer.materialdatetimepicker.R.font.robotomedium));
    ...
    if (!mEnableSeconds) {
      ...
      view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_separator_seconds)
    ...
    if (!mEnableMinutes) {
      ...
      view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_separator)
          .setVisibility(View.GONE);
    }
    ...
    if (isLandscape) {
      if (!mEnableMinutes && !mEnableSeconds) {
        ...
        paramsHour.addRule(RelativeLayout.ABOVE,
            ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_center_view);
        ...
        if (mIs24HourMode) {
          ...
          paramsAmPm.addRule(RelativeLayout.RIGHT_OF,
              ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_hour_space);
        ...
        paramsSeparator.addRule(RelativeLayout.CENTER_HORIZONTAL);
        paramsSeparator.addRule(RelativeLayout.ABOVE,
            ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_seconds_space);
        TextView separatorView =
            view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_separator);
        separatorView.setLayoutParams(paramsSeparator);
        // Center the seconds
      ...
      paramsSeparator.addRule(RelativeLayout.LEFT_OF,
          ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_minutes_space);
    ...
    mDoublePlaceholderText =
        res.getString(ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_time_placeholder);
    mDeletedKeyFormat =
        res.getString(ir.wdullaer.materialdatetimepicker.R.string.fh_gig_mdtp_deleted_key);
    ...
    TextView timePickerHeader =
        view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_time_picker_header);
    if (!mTitle.isEmpty()) {
    ...
    view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_time_display_background)
        .setBackgroundColor(mAccentColor);
    view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_time_display)
        .setBackgroundColor(mAccentColor);
    ...
    if (getDialog() == null) {
      view.findViewById(ir.wdullaer.materialdatetimepicker.R.id.fh_gig_mdtp_done_background)
          .setVisibility(View.GONE);
    }

    int circleBackground = ContextCompat.getColor(context,
        ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_circle_background);
    int backgroundColor = ContextCompat.getColor(context,
        ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_background_color);
    int darkBackgroundColor = ContextCompat.getColor(context,
        ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_light_gray);
