  ...
  public void initialize(Context context, Locale locale, TimePickerController controller,
    ...
    if (controller.isThemeDark()) {
      mUnselectedColor = ContextCompat.getColor(context,
          ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_circle_background_dark_theme);
      ...
      mUnselectedColor = ContextCompat.getColor(context,
          ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_white);
      mAmPmTextColor = ContextCompat.getColor(context,
          ir.wdullaer.materialdatetimepicker.R.color.fh_gig_mdtp_ampm_text_color);
      mAmPmDisabledTextColor = ContextCompat.getColor(context,
